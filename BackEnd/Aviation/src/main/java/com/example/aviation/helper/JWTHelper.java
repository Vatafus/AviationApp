//package com.example.aviation.helper;
//
...
//
//import static com.example.aviation.constant.JWTUtil.*;
//
//@Component
...
//
//    public String generateAccessTocken(String email, List<String> roles){
//        return JWT.create()
//                .withSubject(email)
