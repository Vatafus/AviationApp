...
//        String jwtAccessToken = jwtHelper.generateAccessTocken(user.getUsername(),user.getAuthorities().stream().map(GrantedAuthority::getAuthority).collect(Collectors.toList()));
